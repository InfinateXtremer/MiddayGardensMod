...
static struct FScriptStruct_ImmediatePhysics_StaticRegisterNativesFAnimNode_RigidBody
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_RigidBody()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			auto NewProp_bFreezeIncomingPoseOnStart_SetBit = [](void* Obj){ ((FAnimNode_RigidBody*)Obj)->bFreezeIncomingPoseOnStart = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bFreezeIncomingPoseOnStart = { UE4CodeGen_Private::EPropertyClass::Bool, "bFreezeIncomingPoseOnStart", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_RigidBody), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bFreezeIncomingPoseOnStart_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bFreezeIncomingPoseOnStart_MetaData, ARRAY_COUNT(NewProp_bFreezeIncomingPoseOnStart_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bTransferBoneVelocities_SetBit = [](void* Obj){ ((FAnimNode_RigidBody*)Obj)->bTransferBoneVelocities = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTransferBoneVelocities = { UE4CodeGen_Private::EPropertyClass::Bool, "bTransferBoneVelocities", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_RigidBody), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bTransferBoneVelocities_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bTransferBoneVelocities_MetaData, ARRAY_COUNT(NewProp_bTransferBoneVelocities_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bFreezeIncomingPoseOnStart,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bTransferBoneVelocities,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_RigidBody_CRC() { return 2547759115U; }
